    ...
    public void onTick() {
        ...
        while (i1 < 16) {
            ...
            while (i2 < 16) {
                ...
                this.field_1146_h[i1 + i2 * 16] = f3 / 10.0f + (this.field_1145_i[(i1 + 0 & 0xF) + (i2 + 0 & 0xF) * 16] + this.field_1145_i[(i1 + 1 & 0xF) + (i2 + 0 & 0xF) * 16] + this.field_1145_i[(i1 + 1 & 0xF) + (i2 + 1 & 0xF) * 16] + this.field_1145_i[(i1 + 0 & 0xF) + (i2 + 1 & 0xF) * 16]) / 4.0f * 0.8f;
                int n = i1 + i2 * 16;
                this.field_1145_i[n] = this.field_1145_i[n] + this.field_1144_j[i1 + i2 * 16] * 0.01f;
                if (this.field_1145_i[i1 + i2 * 16] < 0.0f) {
                    this.field_1145_i[i1 + i2 * 16] = 0.0f;
                }
                int n2 = i1 + i2 * 16;
                this.field_1144_j[n2] = this.field_1144_j[n2] - 0.06f;
