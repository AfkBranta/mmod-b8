...
public class AxisAlignedBB {
    ...
    public double calculateXOffset(AxisAlignedBB axisAlignedBB1, double d2) {
        if (axisAlignedBB1.maxY > this.minY && axisAlignedBB1.minY < this.maxY) {
            if (axisAlignedBB1.maxZ > this.minZ && axisAlignedBB1.minZ < this.maxZ) {
                double d4;
                if (d2 > 0.0 && axisAlignedBB1.maxX <= this.minX && (d4 = this.minX - axisAlignedBB1.maxX) < d2) {
                    d2 = d4;
                }
                if (d2 < 0.0 && axisAlignedBB1.minX >= this.maxX && (d4 = this.maxX - axisAlignedBB1.minX) > d2) {
                    d2 = d4;
                }
                return d2;
            }
    ...
    public double calculateYOffset(AxisAlignedBB axisAlignedBB1, double d2) {
        if (axisAlignedBB1.maxX > this.minX && axisAlignedBB1.minX < this.maxX) {
            if (axisAlignedBB1.maxZ > this.minZ && axisAlignedBB1.minZ < this.maxZ) {
                double d4;
                if (d2 > 0.0 && axisAlignedBB1.maxY <= this.minY && (d4 = this.minY - axisAlignedBB1.maxY) < d2) {
                    d2 = d4;
                }
                if (d2 < 0.0 && axisAlignedBB1.minY >= this.maxY && (d4 = this.maxY - axisAlignedBB1.minY) > d2) {
                    d2 = d4;
                }
                return d2;
            }
    ...
    public double calculateZOffset(AxisAlignedBB axisAlignedBB1, double d2) {
        if (axisAlignedBB1.maxX > this.minX && axisAlignedBB1.minX < this.maxX) {
            if (axisAlignedBB1.maxY > this.minY && axisAlignedBB1.minY < this.maxY) {
                double d4;
                if (d2 > 0.0 && axisAlignedBB1.maxZ <= this.minZ && (d4 = this.minZ - axisAlignedBB1.maxZ) < d2) {
                    d2 = d4;
                }
                if (d2 < 0.0 && axisAlignedBB1.minZ >= this.maxZ && (d4 = this.maxZ - axisAlignedBB1.minZ) > d2) {
                    d2 = d4;
                }
                return d2;
            }
