...
extends GuiScreen {
    ...
    protected String getSaveName(int i1) {
        ...
        if (string2 == null || MathHelper.stringNullOrLengthZero(string2)) {
            ...
            string2 = String.valueOf(stringTranslate3.translateKey("selectWorld.world")) + " " + (i1 + 1);
        }
        return string2;
    }
    ...
    public void initButtons() {
        StringTranslate stringTranslate1 = StringTranslate.getInstance();
        this.buttonSelect = new GuiButton(1, this.width / 2 - 154, this.height - 52, 150, 20, stringTranslate1.translateKey("selectWorld.select"));
        this.controlList.add(this.buttonSelect);
        this.buttonRename = new GuiButton(6, this.width / 2 - 154, this.height - 28, 70, 20, stringTranslate1.translateKey("selectWorld.rename"));
        this.controlList.add(this.buttonRename);
        this.buttonDelete = new GuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, stringTranslate1.translateKey("selectWorld.delete"));
    ...
    static int onElementSelected(GuiSelectWorld guiSelectWorld0, int i1) {
        guiSelectWorld0.selectedWorld = i1;
