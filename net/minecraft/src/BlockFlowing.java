...
extends BlockFluids {
    ...
    private void func_22034_j(World world1, int i2, int i3, int i4) {
    ...
    public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
        ...
        if (i6 > 0) {
            ...
            i10 = (i12 = this.getSmallestFlowDecay(world1, i2, i3, i4 + 1, i12)) + b7;
            if (i10 >= 8 || i12 < 0) {
                i10 = -1;
            }
            ...
            if (i10 != i6) {
                ...
                this.func_22034_j(world1, i2, i3, i4);
            }
        } else {
            this.func_22034_j(world1, i2, i3, i4);
        }
        ...
        while (i8 < 4) {
            if (!(i8 == 0 && i6 == 1 || i8 == 1 && i6 == 0 || i8 == 2 && i6 == 3 || i8 == 3 && i6 == 2)) {
                ...
                if (!(this.blockBlocksFlow(world1, i9, i3, i11) || world1.getBlockMaterial(i9, i3, i11) == this.blockMaterial && world1.getBlockMetadata(i9, i3, i11) == 0)) {
                    ...
                    if (i5 < 4 && (i12 = this.calculateFlowCost(world1, i9, i3, i11, i5 + 1, i8)) < i7) {
                        i7 = i12;
                    }
                }
            }
    ...
    private boolean[] getOptimalFlowDirections(World world1, int i2, int i3, int i4) {
        ...
        while (i5 < 4) {
            ...
            if (!(this.blockBlocksFlow(world1, i6, i3, i8) || world1.getBlockMaterial(i6, i3, i8) == this.blockMaterial && world1.getBlockMetadata(i6, i3, i8) == 0)) {
                this.flowCost[i5] = !this.blockBlocksFlow(world1, i6, i3 - 1, i8) ? 0 : this.calculateFlowCost(world1, i6, i3, i8, 1, i5);
            }
            ++i5;
        }
        i5 = this.flowCost[0];
