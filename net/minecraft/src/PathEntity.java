...
public class PathEntity {
    ...
    public Vec3D getPosition(Entity entity1) {
        double d2 = (double)this.points[this.pathIndex].xCoord + (double)((int)(entity1.width + 1.0f)) * 0.5;
        double d4 = this.points[this.pathIndex].yCoord;
        double d6 = (double)this.points[this.pathIndex].zCoord + (double)((int)(entity1.width + 1.0f)) * 0.5;
