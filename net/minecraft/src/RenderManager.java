...
public class RenderManager {
    ...
    private RenderManager() {
        ...
        for (Render render2 : this.entityRenderMap.values()) {
    ...
    public void cacheActiveRenderInfo(World world1, RenderEngine renderEngine2, FontRenderer fontRenderer3, EntityLiving entityLiving4, GameSettings gameSettings5, float f6) {
        ...
        field_1222_l = entityLiving4.lastTickPosX + (entityLiving4.posX - entityLiving4.lastTickPosX) * (double)f6;
        field_1221_m = entityLiving4.lastTickPosY + (entityLiving4.posY - entityLiving4.lastTickPosY) * (double)f6;
        field_1220_n = entityLiving4.lastTickPosZ + (entityLiving4.posZ - entityLiving4.lastTickPosZ) * (double)f6;
    }
    ...
    public double func_851_a(double d1, double d3, double d5) {
        double d7 = d1 - field_1222_l;
        double d9 = d3 - field_1221_m;
        double d11 = d5 - field_1220_n;
