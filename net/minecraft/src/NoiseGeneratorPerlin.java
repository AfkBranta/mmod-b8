...
extends NoiseGenerator {
    ...
    public NoiseGeneratorPerlin(Random random1) {
        this.xCoord = random1.nextDouble() * 256.0;
        this.yCoord = random1.nextDouble() * 256.0;
        this.zCoord = random1.nextDouble() * 256.0;
        int i2 = 0;
        while (i2 < 256) {
    ...
    public double generateNoise(double d1, double d3, double d5) {
        ...
        int i17 = i14 & 0xFF;
        int i18 = i15 & 0xFF;
        double d19 = (d7 -= (double)i13) * d7 * d7 * (d7 * (d7 * 6.0 - 15.0) + 10.0);
        double d21 = (d9 -= (double)i14) * d9 * d9 * (d9 * (d9 * 6.0 - 15.0) + 10.0);
        double d23 = (d11 -= (double)i15) * d11 * d11 * (d11 * (d11 * 6.0 - 15.0) + 10.0);
    ...
    public void func_805_a(double[] d1, double d2, double d4, double d6, int i8, int i9, int i10, double d11, double d13, double d15, double d17) {
        if (i9 == 1) {
            ...
            int i30 = 0;
            while (i30 < i8) {
                double d31 = (d2 + (double)i30) * d11 + this.xCoord;
                int i78 = (int)d31;
                if (d31 < (double)i78) {
                    --i78;
                }
                int i34 = i78 & 0xFF;
                double d35 = (d31 -= (double)i78) * d31 * d31 * (d31 * (d31 * 6.0 - 15.0) + 10.0);
                int i37 = 0;
                while (i37 < i10) {
                    int i10001;
                    double d38 = (d6 + (double)i37) * d15 + this.zCoord;
                    int i40 = (int)d38;
                    if (d38 < (double)i40) {
                        --i40;
                    }
                    int i41 = i40 & 0xFF;
                    double d42 = (d38 -= (double)i40) * d38 * d38 * (d38 * (d38 * 6.0 - 15.0) + 10.0);
                    int i19 = this.permutations[i34] + 0;
                    int i66 = this.permutations[i19] + i41;
                    int i67 = this.permutations[i34 + 1] + 0;
                    int i22 = this.permutations[i67] + i41;
            ...
            while (i37 < i8) {
                ...
                while (i44 < i10) {
                    ...
                    int i48 = i47 & 0xFF;
                    double d49 = (d45 -= (double)i47) * d45 * d45 * (d45 * (d45 * 6.0 - 15.0) + 10.0);
                    int i51 = 0;
                    while (i51 < i9) {
                        int i10001;
                        ...
                        int i55 = i54 & 0xFF;
                        double d56 = (d52 -= (double)i54) * d52 * d52 * (d52 * (d52 * 6.0 - 15.0) + 10.0);
                        if (i51 == 0 || i55 != i22) {
                            i22 = i55;
                            ...
                            int i75 = this.permutations[i74] + i48;
