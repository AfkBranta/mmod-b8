...
extends NBTBase {
    ...
    void writeTagContents(DataOutput dataOutput1) throws IOException {
        for (NBTBase nBTBase3 : this.tagMap.values()) {
    ...
    public byte getByte(String string1) {
        return !this.tagMap.containsKey(string1) ? (byte)0 : ((NBTTagByte)this.tagMap.get((Object)string1)).byteValue;
    }

    public short getShort(String string1) {
        return !this.tagMap.containsKey(string1) ? (short)0 : ((NBTTagShort)this.tagMap.get((Object)string1)).shortValue;
    }

    public int getInteger(String string1) {
        return !this.tagMap.containsKey(string1) ? 0 : ((NBTTagInt)this.tagMap.get((Object)string1)).intValue;
    }

    public long getLong(String string1) {
        return !this.tagMap.containsKey(string1) ? 0L : ((NBTTagLong)this.tagMap.get((Object)string1)).longValue;
    }

    public float getFloat(String string1) {
        return !this.tagMap.containsKey(string1) ? 0.0f : ((NBTTagFloat)this.tagMap.get((Object)string1)).floatValue;
    }

    public double getDouble(String string1) {
        return !this.tagMap.containsKey(string1) ? 0.0 : ((NBTTagDouble)this.tagMap.get((Object)string1)).doubleValue;
    }

    public String getString(String string1) {
        return !this.tagMap.containsKey(string1) ? "" : ((NBTTagString)this.tagMap.get((Object)string1)).stringValue;
    }

    public byte[] getByteArray(String string1) {
        return !this.tagMap.containsKey(string1) ? new byte[]{} : ((NBTTagByteArray)this.tagMap.get((Object)string1)).byteArray;
    }
