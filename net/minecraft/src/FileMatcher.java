...
implements Comparable {
    ...
    public int func_22322_a(FileMatcher fileMatcher1) {
        int i2 = this.field_22325_b >> 5;
        int i3 = fileMatcher1.field_22325_b >> 5;
        if (i2 == i3) {
            int i4 = this.field_22327_c >> 5;
            int i5 = fileMatcher1.field_22327_c >> 5;
            return i4 - i5;
        }
        return i2 - i3;
    }
    ...
    public int compareTo(Object object1) {
        return this.func_22322_a((FileMatcher)object1);
    }
}
