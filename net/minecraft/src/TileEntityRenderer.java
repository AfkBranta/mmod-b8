...
public class TileEntityRenderer {
    ...
    private TileEntityRenderer() {
        ...
        for (TileEntitySpecialRenderer tileEntitySpecialRenderer2 : this.specialRendererMap.values()) {
    ...
    public void renderTileEntity(TileEntity tileEntity1, float f2) {
        if (tileEntity1.getDistanceFrom(this.playerX, this.playerY, this.playerZ) < 4096.0) {
