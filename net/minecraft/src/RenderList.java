...
public class RenderList {
    ...
    public void func_860_a() {
        if (this.field_1235_h) {
            ...
            if (this.field_1236_g.remaining() > 0) {
                GL11.glPushMatrix();
                GL11.glTranslatef((float)((float)this.field_1242_a - this.field_1239_d), (float)((float)this.field_1241_b - this.field_1238_e), (float)((float)this.field_1240_c - this.field_1237_f));
