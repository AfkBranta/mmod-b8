...
public class MetadataChunkBlock {
    ...
    public void func_4127_a(World world1) {
        ...
        if (i5 > 32768) {
            ...
            boolean z8 = false;
            boolean z9 = false;
            int i10 = this.field_1298_b;
            while (i10 <= this.field_1302_e) {
                int i11 = this.field_1303_d;
                while (i11 <= this.field_1300_g) {
                    int i12 = i10 >> 4;
                    int i13 = i11 >> 4;
                    boolean z14 = false;
                    if (z8 && i12 == i6 && i13 == i7) {
                        ...
                        if (z14 && (chunk15 = world1.getChunkFromChunkCoords(i10 >> 4, i11 >> 4)).func_21167_h()) {
                            z14 = false;
                        }
                        z9 = z14;
                        i6 = i12;
                    ...
                    if (z14) {
                        ...
                        int i27 = this.field_1304_c;
                        while (i27 <= this.field_1301_f) {
                            int i21;
                            int i28;
    ...
    public boolean func_866_a(int i1, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (i1 >= this.field_1298_b - b7 && i2 >= this.field_1304_c - b7 && i3 >= this.field_1303_d - b7 && i4 <= this.field_1302_e + b7 && i5 <= this.field_1301_f + b7 && i6 <= this.field_1300_g + b7) {
            ...
            if ((i15 = (i11 = i4 - i1) * (i12 = i5 - i2) * (i13 = i6 - i3)) - (i14 = i8 * i9 * i10) <= 2) {
