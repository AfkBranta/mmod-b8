...
extends Entity {
    ...
    public void func_20048_a(double d1, double d3, double d5, float f7, float f8) {
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.multiplayerWorld) {
            ...
            while (i8 < list5.size()) {
                ...
                if (entity9.canBeCollidedWith() && (entity9 != this.field_20051_g || this.field_20049_i >= 5) && (movingObjectPosition12 = (axisAlignedBB11 = entity9.boundingBox.expand(f10 = 0.3f, f10, f10)).func_1169_a(vec3D15, vec3D2)) != null && ((d13 = vec3D15.distanceTo(movingObjectPosition12.hitVec)) < d6 || d6 == 0.0)) {
                    entity4 = entity9;
                    d6 = d13;
                }
                ++i8;
        ...
        this.rotationPitch = (float)(Math.atan2(this.motionY, f20) * 180.0 / 3.1415927410125732);
    ...
    public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
        ...
        this.field_20053_e = nBTTagCompound1.getByte("inTile") & 0xFF;
        this.field_20057_a = nBTTagCompound1.getByte("shake") & 0xFF;
